...
- **Optional terminal task view** - the first `fm-tui` slice provides a compact keyboard-only task selector, current-state inspector, durable Reports view, bounded read-only Live view, and deterministic snapshot without changing fleet state.
